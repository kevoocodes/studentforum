            ...
            <div class="row">
                <div class="col-md-9 bg-light">
                    ...
                    if(isset($_GET['profileid'])){
                        $id = $_GET['profileid'];
                        $sql = $con->query("SELECT * FROM students WHERE studentID = '$id'");
                    ...
                    ?>
                    <h1  class="lead align-items-center mt-5 mb-3"><?php echo $sqlfetch['username']; ?> Profile </h1>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7 border-right border-bottom" id="profileThings">
                            <h2 class="lead mb-3">
                            <strong style="font-size: 12px;"> <b> Username </b></strong>  : <?php echo $sqlfetch['username']; ?>
                            </h2>

                            <h2 class="lead mb-3">
                            <strong style="font-size: 12px;"> <b> Email </b></strong>  : <?php echo $sqlfetch['email']; ?>
                            </h2>

                            <h2 class="lead mb-3">
                            <strong style="font-size: 12px;"> <b> Name </b></strong> : <?php echo $sqlfetchinfo['name']; ?>
                            </h2>
                            ...
                            <h2 class="lead mb-3">
                               <strong style="font-size: 12px;"> <b> Faculty </b></strong> :  <?php echo $sqlfetchinfo['faculty']; ?>
                            </h2>
