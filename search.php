                                ...
                                ?>
                                     ...
                                     <div class='row mb-3 pt-2 pb-2' id="topic" style="margin-left: 10px;margin-right: 10px; box-shadow: 5px 5px 10px #cccccc;">
                                            ...
                                            <div class='col-md-10'>
                                                ...
                                                <h2><a id='linkTrending' href='studentprofile1.php?profileid=<?php echo $id; ?>'> <?php echo $row['username'];  ?></a></h2>
                            ...
                            ?>
                                        ...
                                        <div class='row mb-3 pt-2 pb-2' id="topic" style="margin-left: 10px;margin-right: 10px; box-shadow: 5px 5px 10px #cccccc;">
                                            ...
                                            <div class='col-md-10'>
                                                ...
                                                <h2><a id='linkTrending' href='singleposts.php?post_id=<?php echo $row['id']; ?>'> <?php echo $row['title']; ?></a></h2>
                                                <p class="overflo"></p>
