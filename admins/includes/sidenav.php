        ...
        <div class="sidebar-content">
                ...
                <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                    ...
                    <div class="content-header-item">
                        <a class="link-effect font-w700" href="dashboard.php">
                            ...
                            <span class="font-size-xl text-dual-primary-dark">Forum</span><span class="font-size-xl text-primary">s</span>
                        </a>
                    </div>
                    <!-- END Logo -->
                </div>
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li>
                        <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide"></span>Manage Student</a>
                        <ul>
                            <li>
                    ...
                    <li class="open">
                        <a href="manage_categories.php"><i class="si si-cup"></i><span class="sidebar-mini-hide">Manage Categories</span></a>
                    </li>
                
                   
                    <li>
                        <a  href="manage_posts.php"><i class="si si-vector"></i><span class="sidebar-mini-hide">Manage Posts</span></a>
                    </li>
